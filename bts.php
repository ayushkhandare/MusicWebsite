...
<head>
    ...
    <title>The Real Sound</title>
    <style>header .song_side::before{
        background: none;
    }</style>
</head>
...
<header>
    <div class="menu_side">
        <h1><a href = 'home.php'><i class="bi bi-music-note-list"></i> The Real Sound</a></h1>
        <div class="playlist">
    ...
    <div class="song_side">
        <nav>
            <ul>
                ...
                <a href = 'music.php' style = "text-decoration: none;"><li>Music</li></a>
            </ul>

            <div class="user">
                <p><a href="music.php?logout='1'" style="color: red; font-size: 15px">LOGOUT </a>
                <a style="color: #36e2ec; font-size: 15px"><?php echo "| USER: ", $_SESSION['username'] ?></a></p>
            </div>
        </nav>
        <div class="content">
            <h1>BTS</h1>
            <p>
                Like an echo in the forest, Another day will come<br>
                as if nothing happened, yeah life goes on<br>
                Like an arrow in the blue sky, Another day will fly by
                On my pillow, on my table<br>
                Yeah life goes on, Like this again
            </p>
            <div class="buttons">
                <button id="play_content">PLAY</button>
        ...
        <div class="popular_artists">
            ...
            <div class="item">
                <li>
                    <a href="bts.php"><img src="img/bts.jpg" alt="BTS" title="BTS"></a>   
                </li>
                <li>
                    <a href="halsey.php"><img src="img/halsey.jpg" alt="Halsey" title="halsey"></a>
                </li>
                <li>
                    <a href="joji.php"><img src="img/joji.jpg" alt="Joji" title="Joji"></a>
                </li>
                <li>
